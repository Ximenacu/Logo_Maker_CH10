...
class Triangle extends Shape {
  ...
  render() {
    // console.log(this)
    // console.log(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150,20 230,180 70,180" fill="${this.fill}" /><text x="150" y="140" font-size="50" text-anchor="middle" fill="${this.color}">${this.text}</text></svg>`)
    return `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150,20 230,180 70,180" fill="${this.fill}" /><text x="150" y="140" font-size="50" text-anchor="middle" fill="${this.color}">${this.text}</text></svg>`; 
  }
}
...
class Square extends Shape {
  ...
  render() {
    // console.log(this)
    // console.log(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x="70" y="20" width="160" height="160" fill="${this.fill}" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.color}">${this.text}</text></svg>`)
    return `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x="70" y="20" width="160" height="160" fill="${this.fill}" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.color}">${this.text}</text></svg>`;
  }
}
...
const triangleLogo1 = new Triangle('ABC', 'red', 'white');
triangleLogo1.render();

const squareLogo1 = new Square('ABC', 'red', 'white');
squareLogo1.render();
